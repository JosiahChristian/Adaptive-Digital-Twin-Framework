...
CONDITIONS = [
    ...
    },
    {
        ...
        "name": "process_disturbance_2.50",
        "measurement_noise_std": 0.50,
        "process_disturbance": 2.50,
        "initial_parameter_estimate": 0.50,
        "changed_true_a": None,
    },
    {
        "class": "process_disturbance",
        "name": "process_disturbance_3.00",
        "measurement_noise_std": 0.50,
        "process_disturbance": 3.00,
        "initial_parameter_estimate": 0.50,
        "changed_true_a": None,
    },
    {
        "class": "parameter_mismatch",
        "name": "parameter_mismatch_0.45",
        "measurement_noise_std": 0.50,
        "process_disturbance": 0.0,
        "initial_parameter_estimate": 0.45,
        "changed_true_a": None,
    },
    {
        "class": "parameter_mismatch",
        "name": "parameter_mismatch_0.40",
        "measurement_noise_std": 0.50,
        "process_disturbance": 0.0,
...
def print_condition_summary(
    ...
    print(
        ...
        "BALANCED EVIDENCE BOUNDARY SAMPLING"
    )
    ...
    for row in rows:
        ...
        print(
            f"{condition:<32}"
            f"evidence="
            f"{str(row['evidence_sufficient']):<6} "
            f"hard="
            f"{row['operating_point_hard_accuracy']:<8.3%} "
            f"coverage="
            f"{row['operating_point_coverage']:<8.3%} "
            f"sel_acc="
            f"{row['operating_point_selective_accuracy']:<8.3%}"
        )

...
OUTPUT_PATH = Path(
    "results/"
    "validated_multiseed_generative_persistence_robustness.csv"
)

FINGERPRINT_PATH = Path(
    "results/"
    "validated_multiseed_generative_persistence_fingerprints.csv"
)

BASE_GENERATION_SEED = 44000

GENERATION_SEEDS = [
    BASE_GENERATION_SEED + offset
...
def main() -> None:
    ...
    print(
        ...
        "VALIDATED MULTI-SEED GENERATIVE "

...
A final preregistered mechanism test provides the strongest explanatory result in the sequence: exclusion-membership changes were concentrated near the intervention cutoff, and the safety composition of those boundary crossings was strongly associated with downstream unsafe-selection changes. The evidence therefore supports decision-layer and local-boundary evaluation as necessary complements to global predictive evaluation in the tested adversarial setting.

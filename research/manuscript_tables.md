...
| 154 | boundary diagnostic | diagnostic | AUC remained nearly unchanged while 41 unsafe-to-safe vs 22 safe-to-unsafe transitions occurred | motivates local cutoff-reordering mechanism |
...
All tables should be described as simulator-internal evidence under the frozen attack, model, population-generation, and fixed-budget intervention procedures. No table supports universal metric superiority, beneficial poisoning, deployment safety, or causal establishment of the local cutoff mechanism.

...
@dataclass
class NormalizedInnovationEstimate:
...
class NormalizedInnovationAdaptiveEstimator:
    """
    Coupled adaptive estimator using normalized innovation
    squared (NIS) as the model-mismatch signal.
    ...
    Excess normalized innovation:

        m_k = max(0, epsilon_k - 1)

    Smoothed mismatch indicator:
    ...
    def step(
        ...
        *,
        ...
        return NormalizedInnovationEstimate(
            state_estimate=(
